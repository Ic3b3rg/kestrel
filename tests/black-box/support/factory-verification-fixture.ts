...
export async function createVerificationFixture(
  ...
  try {
    ...
    await stack.executeSql(`
      ...
      BEGIN IF NEW.name IN ('factory-execution-v1','factory-feature-pr-publication-v1','factory-review-correction-v1','factory-conceptual-review-v1','factory-feature-merge-v1') THEN NEW.start_after=clock_timestamp()+interval '1 hour'; END IF; RETURN NEW; END $$;
