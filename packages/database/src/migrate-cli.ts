...
import {
  ...
  FACTORY_FEATURE_PUBLICATION_QUEUE_OPTIONS,
  FACTORY_EXECUTION_QUEUE,
  FACTORY_EXECUTION_QUEUE_OPTIONS,
  FACTORY_CONCEPTUAL_REVIEW_QUEUE,
  FACTORY_CONCEPTUAL_REVIEW_QUEUE_OPTIONS,
  FACTORY_CORRECTION_QUEUE,
  FACTORY_CORRECTION_QUEUE_OPTIONS,
  FACTORY_MERGE_QUEUE,
  FACTORY_MERGE_QUEUE_OPTIONS,
} from "./pg-boss.js";
...
try {
  ...
  await boss.createQueue(FACTORY_PUBLICATION_QUEUE, FACTORY_PUBLICATION_QUEUE_OPTIONS);
  await boss.updateQueue(FACTORY_PUBLICATION_QUEUE, FACTORY_PUBLICATION_QUEUE_OPTIONS);
  ...
  await boss.createQueue(FACTORY_EXECUTION_QUEUE, FACTORY_EXECUTION_QUEUE_OPTIONS);
  await boss.updateQueue(FACTORY_EXECUTION_QUEUE, FACTORY_EXECUTION_QUEUE_OPTIONS);
  await boss.createQueue(FACTORY_CONCEPTUAL_REVIEW_QUEUE, FACTORY_CONCEPTUAL_REVIEW_QUEUE_OPTIONS);
  await boss.updateQueue(FACTORY_CONCEPTUAL_REVIEW_QUEUE, FACTORY_CONCEPTUAL_REVIEW_QUEUE_OPTIONS);
  await boss.createQueue(FACTORY_CORRECTION_QUEUE, FACTORY_CORRECTION_QUEUE_OPTIONS);
  await boss.updateQueue(FACTORY_CORRECTION_QUEUE, FACTORY_CORRECTION_QUEUE_OPTIONS);
  await boss.createQueue(FACTORY_MERGE_QUEUE, FACTORY_MERGE_QUEUE_OPTIONS);
  await boss.updateQueue(FACTORY_MERGE_QUEUE, FACTORY_MERGE_QUEUE_OPTIONS);
  console.log(
    JSON.stringify({
